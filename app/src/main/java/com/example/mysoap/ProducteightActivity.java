...
public class ProducteightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_producteight);

        Button btn2 = (Button) findViewById(R.id.btn1);
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProducteightActivity.this, CartActivity.class);
        ...
        Img1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProducteightActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                ModelCart modelCart = new ModelCart("01",R.drawable.g6,"แชมพุ ฟักข้าว",Integer.parseInt(amount.getText().toString()),price.getText().toString());
//                MainActivity.CartList.add(modelCart);
//                Toast.makeText(ProducteightActivity.this,"ใส่ตะกร้าเรียบร้อยแล้ว",Toast.LENGTH_LONG).show();
//            }
//        });
    }
}