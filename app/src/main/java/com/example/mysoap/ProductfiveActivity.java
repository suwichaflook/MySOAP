...
public class ProductfiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productfive);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductfiveActivity.this, CartActivity.class);
        ...
        Img1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductfiveActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                ModelCart modelCart = new ModelCart("01",R.drawable.g7,"แชมพู อัญชัน",Integer.parseInt(amount.getText().toString()),price.getText().toString());
//                MainActivity.CartList.add(modelCart);
//                Toast.makeText(ProductfiveActivity.this,"ใส่ตะกร้าเรียบร้อยแล้ว",Toast.LENGTH_LONG).show();
//            }
//        });
    }
}