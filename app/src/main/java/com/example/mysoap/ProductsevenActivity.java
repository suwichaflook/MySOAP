...
public class ProductsevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productseven);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductsevenActivity.this, CartActivity.class);
        ...
        Img1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductsevenActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                ModelCart modelCart = new ModelCart("01",R.drawable.g5,"โลชั่นแตงกวา",Integer.parseInt(amount.getText().toString()),price.getText().toString());
//                MainActivity.CartList.add(modelCart);
//                Toast.makeText(ProductsevenActivity.this,"ใส่ตะกร้าเรียบร้อยแล้ว",Toast.LENGTH_LONG).show();
//            }
//        });
    }
}
