...
public class ProductthreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productthree);

        Button btn2 = (Button) findViewById(R.id.btn1);
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductthreeActivity.this, CartActivity.class);
        ...
        Img1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductthreeActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                ModelCart modelCart = new ModelCart("01",R.drawable.g3,"สบู่ยางนาและฝาง",Integer.parseInt(amount.getText().toString()),price.getText().toString());
//                MainActivity.CartList.add(modelCart);
//                Toast.makeText(ProductthreeActivity.this,"ใส่ตะกร้าเรียบร้อยแล้ว",Toast.LENGTH_LONG).show();
//            }
//        });
    }
}